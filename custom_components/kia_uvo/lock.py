...
class Lock(KiaUvoEntity, LockEntity):
    ...
    async def async_lock(self):
        self.hass.async_create_task(self.vehicle.lock_action(VEHICLE_LOCK_ACTION.LOCK))

    async def async_unlock(self):
        self.hass.async_create_task(self.vehicle.lock_action(VEHICLE_LOCK_ACTION.UNLOCK))
